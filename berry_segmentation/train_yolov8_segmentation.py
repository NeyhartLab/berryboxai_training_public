# BerryBox Fruit Segmentation

## Train YOLO V8 Instance Segmentation Model
...
project = "berrybox_berry_segmentation" # project name
...
if not resume_training:
    model = YOLO('yolov8' + model_size + '-seg.pt')  # load a pretrained model (recommended for training)
    # model = YOLO('yolov8' + model_size + '-seg.pt').load(weights)
...
keys = [key for key in val_results.names]
